  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        {/* Leaf icon — custom SVG, not emoji */}
        <svg
          width="18"
          height="18"
          viewBox="0 0 24 24"
        ...
        <div className="flex-1 min-w-0">
          ...
          {insight.followUp && (
            <button className="mt-3 text-sm text-green-primary font-body font-medium bg-green-light px-3 py-1.5 rounded-full hover:bg-green-glow transition-colors cursor-pointer">
              {insight.followUp}
            </button>
          )}
        </div>
